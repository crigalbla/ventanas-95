...
const translations: Translations = {
	es: {
		...
		usingTouchableDevice2: "Recuerda que 'Ventanas 95' es un sistema operativo para ordenadores, no podrás ver toda su funcionalidad aquí,",
	...
	en: {
		...
		usingTouchableDevice2: "Remember that 'Ventanas 95' is an operating system for computers, you will not be able to see all its functionality here,",
